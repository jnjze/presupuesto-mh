...
import com.medihelp.presupuesto.service.dto.UserDTO;
...
class UserMapperTest {
    ...
    public void init() {
        ...
        authority.setName(AuthoritiesConstants.EMPLOYMENT);
    ...
    void testUserToUserDTO() {
        ...
        assertThat(convertedUserDto.getAuthorities()).containsExactly(AuthoritiesConstants.EMPLOYMENT);
    }
    ...
    void testUserDTOtoUser() {
        ...
        assertThat(convertedUser.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.EMPLOYMENT);
    }
    ...
    void userDTOToUserMapWithAuthoritiesStringShouldReturnUserWithAuthorities() {
        ...
        assertThat(convertedUser.getAuthorities().iterator().next().getName()).isEqualTo(AuthoritiesConstants.EMPLOYMENT);
    }
