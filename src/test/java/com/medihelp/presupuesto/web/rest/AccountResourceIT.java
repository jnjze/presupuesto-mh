...
import com.medihelp.presupuesto.config.Constants;
import com.medihelp.presupuesto.domain.User;
import com.medihelp.presupuesto.repository.AuthorityRepository;
import com.medihelp.presupuesto.repository.UserRepository;
import com.medihelp.presupuesto.security.AuthoritiesConstants;
import com.medihelp.presupuesto.service.UserService;
import com.medihelp.presupuesto.service.dto.AdminUserDTO;
import com.medihelp.presupuesto.service.dto.PasswordChangeDTO;
import com.medihelp.presupuesto.web.rest.vm.KeyAndPasswordVM;
import com.medihelp.presupuesto.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.EMPLOYMENT));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.EMPLOYMENT));
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.EMPLOYMENT));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.orElseThrow().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.EMPLOYMENT).orElseThrow());
