...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './rubro.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RUBRO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RUBRO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RUBRO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RUBRO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RUBRO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RUBRO actions', async () => {
      const arg = 42666;
