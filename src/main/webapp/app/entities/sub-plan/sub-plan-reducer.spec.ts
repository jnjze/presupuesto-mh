...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './sub-plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBPLAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBPLAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBPLAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBPLAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBPLAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBPLAN actions', async () => {
      const arg = 42666;
