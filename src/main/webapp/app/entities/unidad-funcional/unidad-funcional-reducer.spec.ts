...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNIDADFUNCIONAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UNIDADFUNCIONAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UNIDADFUNCIONAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UNIDADFUNCIONAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UNIDADFUNCIONAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UNIDADFUNCIONAL actions', async () => {
      const arg = 42666;
