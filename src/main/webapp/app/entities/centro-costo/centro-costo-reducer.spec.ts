...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENTROCOSTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CENTROCOSTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CENTROCOSTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CENTROCOSTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CENTROCOSTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CENTROCOSTO actions', async () => {
      const arg = 42666;
