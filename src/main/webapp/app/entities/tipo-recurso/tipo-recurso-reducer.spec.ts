...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPORECURSO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TIPORECURSO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TIPORECURSO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TIPORECURSO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TIPORECURSO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TIPORECURSO actions', async () => {
      const arg = 42666;
