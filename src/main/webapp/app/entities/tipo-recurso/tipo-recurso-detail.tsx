...
export const TipoRecursoDetail = () => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="tipoRecursoDetailsHeading">Tipo Recurso</h2>
        <dl className="jh-entity-details">
          ...
          <dd>{tipoRecursoEntity.codigo}</dd>
          <dt>
            <span id="nombre">Nombre</span>
          </dt>
          <dd>{tipoRecursoEntity.nombre}</dd>
          <dt>
            <span id="descripcion">Descripcion</span>
          </dt>
          <dd>{tipoRecursoEntity.descripcion}</dd>
        </dl>
...
export default TipoRecursoDetail;
