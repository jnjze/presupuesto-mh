...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './recurso.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECURSO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RECURSO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RECURSO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RECURSO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RECURSO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RECURSO actions', async () => {
      const arg = 42666;
